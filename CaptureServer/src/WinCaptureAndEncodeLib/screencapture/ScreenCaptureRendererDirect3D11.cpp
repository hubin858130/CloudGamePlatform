#include "ScreenCaptureRendererDirect3D11.h"
...
//	  settings.cb_scaled((void*)&map, settings.output_width, settings.output_height, settings.cb_user);
  ...
  int ScreenCaptureRendererDirect3D11::getTextureFrame(ID3D11Texture2D*& pFrameTexture)
  {
	  int nRet = 0;
//	  if (NULL == src_tex_view)
//	  {
...
//	  pFrameTexture = staging_tex;
  ...
  void ScreenCaptureRendererDirect3D11::showCursor(bool bShow)
  {
	  m_bShowCursor = bShow;
  }
